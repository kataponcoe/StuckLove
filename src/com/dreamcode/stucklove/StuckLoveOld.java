...
public class StuckLoveOld extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stucklove_old);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.mainmenublank);
